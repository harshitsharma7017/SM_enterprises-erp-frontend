...
const REPORT_LINKS = [
  ...
  ['/reports/stock', 'bi-boxes', 'Lot Stock Report', 'stock.view'],
  ['/reports/qc', 'bi-clipboard-check', 'QC / Rejections', 'inward-entry.view'],
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto sidebar-scroll mt-2">
        <ul className="list-none p-0 m-0">
          ...
          {/* ═══════ REPORTS ═══════ */}
          {canAny(['outstanding.view', 'report.view', 'report.import']) && (
            <>
              ...
              <NavItem href="/reports/import" icon="bi-file-earmark-arrow-up" label="Excel Import" permission="report.import" can={can} collapsed={collapsed} isActive={isActive} />
            </>
          )}
