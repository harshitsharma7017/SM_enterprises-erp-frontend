        ...
        <div className="overflow-x-auto border border-gray-200 rounded-md">
          <table className="min-w-full divide-y divide-gray-200 text-sm text-left">
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              {loading ? (
                <tr><td colSpan="8" className="text-center py-8 text-gray-500">Loading processing records...</td></tr>
              ) : rows.length === 0 ? (
                <EmptyState colspan={8} icon="bi-gear-wide-connected" title="No processing records" message="Start processing from an issued material issue." />
              ) : rows.map((p) => (
